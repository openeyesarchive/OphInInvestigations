...
class OphInInvestigationsModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphInInvestigations.models.*',
			'OphInInvestigations.components.*',
		));

		$this->moduleShortSuffix = "investigations";
	}
